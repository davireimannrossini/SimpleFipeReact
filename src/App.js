...
function App() {
  ...
  <div className="container">
    <h2 className="margin-title">Consulta API FIPE</h2>
    ...
    <div className="form-group">
      ...
      <select className="form-control form-select form-select-lg select-custom" id="marcas" onChange={(e) => buscarModelos(e.target.value)}>
    ...
    <div className="form-group">
      ...
      <select className="form-control form-select form-select-lg select-custom" id="modelos" disabled={!modelos.length} onChange={(e) => buscarAnos(document.getElementById('marcas').value, e.target.value)}>
    ...
    <div className="form-group">
      ...
      <select className="form-control form-select form-select-lg select-custom" id="anos" disabled={!anos.length} onChange={(e) => buscarFipeInfo(document.getElementById('marcas').value, document.getElementById('modelos').value, e.target.value)}>
    ...
    {fipeInfo && (
      <div className="fipe-info container jumbotron">
        <h4 className="margin-title">Informações</h4>
